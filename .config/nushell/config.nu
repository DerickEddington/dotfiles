# For interactive Nu shells.
#
# version = "0.86.0"

# TODO: see about moving to its own module, to hide this var
...
let my_theme = {
    ...
    separator: white  # Usually rendered as a light grey.
    leading_trailing_space_bg: { attr: n } # no fg, no bg, attr none effectively turns this off
    header: { fg: green_bold attr: i }
    empty: blue
...
$env.config = {
    ...
    history: {
        max_size: 10_000_000 # Practically unlimited, but limited against madness.
    ...
    hooks: {
        ...
        command_not_found: {|prog_name| # return an error message when a command is not found
            # TODO: Make this use different ways depending on the current platform.
            hide-env --ignore-errors NIX_AUTO_RUN
            do { ^command-not-found $prog_name } | complete | get stderr
        }
    }
...
# Do this after `$env.config` is assigned, because this mutates some of that.
#
source ($nu.config-path | path dirname | path join "my" "interactive.nu")
