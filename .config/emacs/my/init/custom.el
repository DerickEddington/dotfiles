...
(custom-set-variables
 ...
 '(gdb-locals-table-row-config '((name . 30) (type . 30) (value . 150)))
 '(gdb-many-windows t)
 ...
 '(remote-file-name-access-timeout 30)
...
(custom-set-faces
 ...
 '(font-lock-constant-face ((t (:foreground "#00590D"))))
 '(font-lock-delimiter-face ((t (:foreground "grey35"))))
 '(font-lock-doc-face ((t (:inherit font-lock-comment-face))))
 '(font-lock-doc-markup-face ((t (:inherit font-lock-doc-face))))
 '(font-lock-escape-face ((t (:foreground "gold4"))))
 ...
 '(font-lock-operator-face ((t (:foreground "#4F4800"))))
 ...
 '(font-lock-regexp-grouping-backslash ((t (:foreground "gold2"))))
 '(font-lock-regexp-grouping-construct ((t (:foreground "gold2"))))
 '(font-lock-string-face ((t (:foreground "#006E10"))))
 '(font-lock-type-face ((t (:foreground "#820000"))))
 ...
 '(isearch-group-1 ((t (:inherit isearch :box (:line-width (-1 . -1) :color "yellow2" :style flat-button)))))
 '(isearch-group-2 ((t (:inherit isearch :box (:line-width (-1 . -1) :color "yellow4" :style flat-button)))))
 ...
 '(sh-escaped-newline ((t (:inherit font-lock-escape-face))))
