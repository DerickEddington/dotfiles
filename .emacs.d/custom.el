(custom-set-variables
 ...
 '(lsp-rust-analyzer-rustfmt-extra-args ["+nightly" "--unstable-features" "--edition" "2018"])
 ...
 '(magit-log-margin '(t age-abbreviated magit-log-margin-width nil 16))
...
")
 ...
 '(rust-rustfmt-switches '("+nightly" "--unstable-features" "--edition" "2018"))
 '(savehist-mode t)
 '(scroll-bar-mode nil)
...
(custom-set-faces
 ...
 '(mode-line ((t (:background "gray70" :foreground "black" :box (:line-width -1 :style released-button)))))
 '(mode-line-inactive ((t (:inherit default :box (:line-width -1 :style released-button) :weight light))))
 ...
 '(widget-field ((t (:background "gray80"))))
