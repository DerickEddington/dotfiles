(custom-set-variables
 ...
 '(dired-listing-switches
   "-l --almost-all --group-directories-first --human-readable -v --classify")
 ...
 '(lsp-rust-analyzer-cargo-watch-args ["--lib" "--bins" "--tests" "--examples"])
 ...
 '(lsp-rust-analyzer-rustfmt-extra-args ["+nightly" "--unstable-features" "--edition" "2021"])
